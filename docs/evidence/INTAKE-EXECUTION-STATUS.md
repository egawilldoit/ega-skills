...
| P06 review and publication preflight | `codex/intake-p06` | Implemented locally; PR pending | HEAD `c90ff9f`; RV-01–RV-04 pass in the targeted suite and the actual CLI exposes exact review and preflight commands. Contract E1/E2 adds append-only CAS review records and a fresh-catalog approval gate. |
