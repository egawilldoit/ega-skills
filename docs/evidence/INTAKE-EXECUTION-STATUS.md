...
| P05 owned derivatives | `codex/intake-p05` | Implemented locally; PR pending | CP-01–CP-04 pass in the real CLI-backed targeted suite. Current implementation adds Contract D1, exact patch/provenance receipts, staged-only derivation, stale-input rejection, conflict handling, and idempotent reapply. |
| P06–P12 | Not started | Dependency-ordered | — |
