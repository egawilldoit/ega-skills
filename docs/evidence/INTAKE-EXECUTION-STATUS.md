...
| P10 immutable release preview/export | `codex/intake-p10` / [PR #108](https://github.com/egawilldoit/ega-skills/pull/108) | Implemented; CI pending | HEAD `c37489b5b93999fadcc10205edb403a62ba4ef97`. Contract R1 and RL-01–RL-03 pass; actual CLI export and blocked preview pass. Local build/typecheck, frozen install, Contracts A/B/C, specs, performance, and diff checks pass. Required Linux/Windows/Contract F CI is pending. |
| P11 retained serving and deployment | Pending | Dependency-ordered | Exact retained-release selection, concurrent publication/rollback, and deployment identity remain. |
| P12 real upstream/client acceptance | Pending | Dependency-ordered | Local end-to-end proof remains; authorized non-production upstream and remote Codex/OpenCode acceptance are not yet available. |
