...
| P05 owned derivatives | `codex/intake-p05` | pending | pending | Implemented locally. Contract D1 and CP-01–CP-04 pass in targeted tests; PR and CI evidence will be recorded after the focused branch is pushed. |
| P06-P12 | pending | pending | pending | Dependency-ordered after P05. |
