...
| P12 real upstream/client acceptance | Pending | Dependency-ordered | Spawned-CLI intake-to-export proof remains; authorized non-production upstream and remote Codex/OpenCode acceptance are not yet available. |
