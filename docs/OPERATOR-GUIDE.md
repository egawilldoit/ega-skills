...
| get_content | skill_id, version_hash, level, max_tokens, file_path?, project_path? | EXACT requested bytes (level body, or ONE exact TEXT companion via file_path) or a frozen error. No fallback/truncation/substitution. |
